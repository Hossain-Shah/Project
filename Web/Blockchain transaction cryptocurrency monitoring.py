...
class BlockChain(object):
    ...
    def get_block_object(block_data):
        return Block(block_data['index'], block_data['proof_number'], block_data['previous_hash'], block_data['data'], timestamp=block_data['timestamp'])
...
blockchain.get_data(
    sender="privatebank@bank.org", #this means that this node has constructed another block
    receiver="hossainshah@yahoo.com",
